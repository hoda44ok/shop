...
import ProductByBrand from './components/ProductByBrand/ProductByBrand';
import ProductByCat from './components/ProductByCat/ProductByCat';
  ...
  const router = createBrowserRouter([
    {
      ...
      children: [
        ...
        { path: "/ProductByBrand/:slug", element: <ProtectedRoute><ProductByBrand /></ProtectedRoute> },
        { path: "/CategoryDetails/:id" , element: <ProtectedRoute><CategoryDetails /></ProtectedRoute>},
        { path: "/ProductByCat/:slug" , element: <ProtectedRoute><ProductByCat /></ProtectedRoute>},
