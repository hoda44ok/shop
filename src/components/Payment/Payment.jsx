...
const Payment = () => {
  ...
  async function cashPayment(e) {
    ...
    try {
      ...
      if (error.response && error.response.status === 401) {
        alert("Session Expired , please login agin");
  ...
  <div className="container mx-auto px-4">
    <form className="max-w-4xl mx-auto bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          <label htmlFor="firstName" className="block mb-1 text-md text-gray-800 dark:text-white">
            First Name
          </label>
          <input
            onChange={(e) => setFirstName(e.target.value)}
        ...
        <div>
          <label htmlFor="lastName" className="block mb-1 text-md text-gray-800 dark:text-white">
            Last Name
          </label>
          <input
            onChange={(e) => setLastName(e.target.value)}
        ...
        <div>
          <label htmlFor="email" className="block mb-1 text-md text-gray-800 dark:text-white">
            Email
          </label>
          <input
            onChange={(e) => setEmail(e.target.value)}
        ...
        <div>
          <label htmlFor="phone" className="block mb-1 text-md text-gray-800 dark:text-white">
            Phone
          </label>
          <input
            onChange={(e) => setPhone(e.target.value)}
        ...
        <div>
          <label htmlFor="details" className="block mb-1 text-md text-gray-800 dark:text-white">
            Address One
          </label>
          <input
            onChange={(e) => setDetails(e.target.value)}
        ...
        <div>
          <label htmlFor="city" className="block mb-1 text-md text-gray-800 dark:text-white">
            Address Two (City)
          </label>
          <input
            onChange={(e) => setCity(e.target.value)}
      ...
      <div className="flex justify-center mt-6">
        <button
          onClick={cashPayment}
          type="button"
          className="bg-teal-700 hover:bg-teal-800 text-white font-medium rounded-lg text-md w-full sm:w-1/2 md:w-1/3 px-5 py-2.5 transition-colors"
        >
          {isLoading ? <i className="fa-solid fa-spin fa-spinner"></i> : "Pay Now"}
        </button>
      </div>
