...
const Wishlist = () => {
  ...
  return (
    <div className="py-5 mx-auto md:w-[85%] mt-16 lg:mb-12 mb-28 shadow-xl shadow-gray-500 dark:shadow-gray-800 dark:bg-gray-900 bg-white px-4 sm:px-6 rounded-lg">
      {wishlist.length === 0 ? (
        <div className="flex flex-col items-center justify-center h-[50vh] text-center bg-gray-50 dark:bg-gray-900 rounded-lg shadow-md p-6">
          <p className="text-gray-500 mt-2 text-2xl font-semibold dark:text-gray-300">
        ...
        <>
              ...
              >
                ...
                <div className="sm:col-span-4 flex justify-center sm:justify-end p-4">
                  <button
                    ...
                    className="border border-blue-600 text-black dark:text-white font-normal hover:bg-blue-600 hover:text-white dark:border-blue-500 dark:hover:bg-blue-600 rounded-lg px-5 h-10 flex items-center justify-center text-lg transition duration-500"
                  >
                    Add to Cart
                  </button>
                </div>
          ...
          <div className="flex justify-center mt-5">
            <button
              ...
              className="border border-red-600 dark:border-red-500 text-red-600 dark:text-red-400 font-normal hover:bg-red-600 dark:hover:bg-red-600 hover:text-white dark:hover:text-white rounded-lg w-[60%] sm:w-[30%] md:w-[20%] h-10 flex items-center justify-center text-lg transition duration-500"
            >
              Clear Wishlist
            </button>
          </div>
